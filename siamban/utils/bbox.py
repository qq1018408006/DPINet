...
def lt2corner_rect(lt):
    corner = lt.copy()
    corner[..., 2] = lt[..., 0] + lt[..., 2]
    corner[..., 3] = lt[..., 1] + lt[..., 3]
    return corner

def center2corner_rect(center):
    if center.ndim == 1:
        center = center[None, :]
    corner = np.zeros_like(center)
    corner[..., 0] = center[..., 0] - 1 / 2 * center[..., 2]
    corner[..., 1] = center[..., 1] - 1 / 2 * center[..., 3]
    corner[..., 2] = center[..., 0] + 1 / 2 * center[..., 2]
    corner[..., 3] = center[..., 1] + 1 / 2 * center[..., 3]
    return corner

def corner2lt(corner):
    lt = corner.copy()
    lt[:, 2] = lt[:, 2] - lt[:, 0]
    lt[:, 3] = lt[:, 3] - lt[:, 1]
    return lt
