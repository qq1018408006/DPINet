...
class DIPNet(SiameseTracker):
    ...
    def init(self, img, bbox):
        ...
        self.model.template(z_crop,torch.from_numpy(bbox), mask=self._get_mask(bbox))


    def _get_mask(self,box):
        points=self.points_template.points
        l=points[0]>box[0]
        r=points[0]<box[2]
        t=points[1]>box[1]
        b=points[1]<box[3]
    ...
    def track(self, img):
        ...
        outputs = self.model.track(x_crop,tracking_hist_info=True)
